function diagnosticarComputadora(emitePitido, discoDuroGira, indice) {
    ...
    alert(`Computadora ${indice}: ${estadoComputadora}`);
    console.log(`Computadora ${indice}: ${estadoComputadora}`);
}
...
for (let i = 0; i < intentos; i++) {
    ...
    diagnosticarComputadora(emitePitido, discoDuroGira, i + 1);
}
